...
if (isset($_GET['action']) && $_GET['action'] == 'delete-cat') {
    $catCtrl->deleteCategory($_GET['cat-id']);
}


$categories = $catCtrl->getCategories();
?>
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list">
                                    <?php foreach ($categories as $key => $category) { ?>
                                        <tr>
                                            <td class="budget"><?= $category['cat_name'] ?></td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item"
                                                            href="edit.php?cat-id=<?= $category['cat_id'] ?>">Edit</a>
