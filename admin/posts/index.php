...
if (isset($_GET['action']) && $_GET['action'] == 'delete-post') {
    $postCtrl->deletePost($_GET['post-id']);
}

if (isset($_GET['action']) && $_GET['action'] == 'mark-as-featured') {
    $postCtrl->markAsFeatured($_GET['post-id']);
}

if (isset($_GET['action']) && $_GET['action'] == 'mark-as-unfeatured') {
    $postCtrl->markAsUnFeatured($_GET['post-id']);
}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav align-items-center  ml-md-auto ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link notification-bell-wrapper" href="#" role="button" data-toggle="dropdown"
                                ...
                                <tbody class="list">
                                    <?php foreach ($posts as $key => $post) { ?>
                                        <tr>
                                                ...
                                                <div class="media align-items-center">
                                                    <a href="#" class="avatar  mr-3">
                                                        <img width='60' height='48'
                                                            src="../../post_images/post_<?= $post['post_id'] ?>/<?= $post['post_image'] ?>" />
                                                    </a>
                                                    <div class="media-body">
                                                        <span class="name mb-0 text-sm">
                                                            <?= substr($post['post_title'], 0, 25) ?>
                                            ...
                                            <td class="budget">
                                                <?= substr(strip_tags(html_entity_decode($post['post_content'])), 0, 60) ?>...
                                            </td>
                                            <td>
                                            ...
                                            <td style="column-width: 50px;">
                                                <span class="badge badge-dot mr-4">
                                                    ...
                                                    <span class="status">
                                                        <?php echo !empty($post['is_featured']) && $post['is_featured'] == 1 ? 'Yes' : 'No' ?>
                                                    </span>
                                                </span>
                                            </td>
                                            <td style="column-width: 80px;"><?= $post['cat_name'] ?></td>
                                            <td class="text-right">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item"
                                                            href="edit.php?post-id=<?= $post['post_id'] ?>">
                                                            Edit
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="?action=delete-post&post-id=<?= $post['post_id'] ?>">
                                                            Delete
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="?action=mark-as-featured&post-id=<?= $post['post_id'] ?>">
                                                            Mark as featured
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="?action=mark-as-unfeatured&post-id=<?= $post['post_id'] ?>">
                                                            Mark as unfeatured
                                                        </a>
                                                    </div>
                                                </div>
